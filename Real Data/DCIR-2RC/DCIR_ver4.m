...
SOC = [optimized_params_struct_final_ver2.SOC]';
Crate = [optimized_params_struct_final_ver2.Crate]';
R0 = [optimized_params_struct_final_ver2.R0]';
R1 = [optimized_params_struct_final_ver2.R1]';
C = [optimized_params_struct_final_ver2.C]';
